...
| 2026-08-04 | CI Smoke Test | Lab 9C | In Progress | Adding a GitHub Actions smoke test that deploys a Lambda function, invokes it after deployment, blocks broken code before merge, and creates a CloudWatch dashboard for operational visibility |