...
| 2026-06-18 | Automated Remediation | Lab 5C | In Progress | Building an automated incident response pipeline using CloudTrail, EventBridge, and Lambda to deactivate newly created IAM access keys |