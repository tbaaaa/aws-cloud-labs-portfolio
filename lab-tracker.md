...
| 2026-08-06 | Monitor Chatbot Dependencies | Lab 10B | In Progress | Creating CloudWatch metric filters, custom metrics, a dashboard, and a latency alarm to monitor the chatbot’s external trivia API dependency |