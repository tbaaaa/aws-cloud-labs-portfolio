...
| 2026-06-03 | CloudTrail Investigation | Lab 4B | In Progress | Creating CloudTrail audit logs, simulating suspicious IAM/S3 activity, and investigating deleted activity with lookup-events |