...
| 2026-05-20 | IAM Groups, Custom Policies & MFA | Lab 3B | In Progress | Creating an IAM group, applying a custom policy with explicit Deny, testing inherited permissions, and enabling root MFA |